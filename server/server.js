...
const aiSearch = require('./routers/aiSearch.js');
const aiPriceSuggestion = require('./routers/aiPriceSuggestion.js');
...
app.use('/users/post',aiSearch);
app.use('/users/post',aiPriceSuggestion);
